...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Anstyle.swiftmodule/`
...
//      `import Anstyle` above would fail at compile time.
//
//   2. The static archive `libAnstyle.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Anstyle" }` and
//      `flattenPackage = "io.github.kotlinmania.anstyle"` configuration in
...
//      via the `AnstyleLibrary` product.
//
...
@Suite struct AnstyleExportTests {
