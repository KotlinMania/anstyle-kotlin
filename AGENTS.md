# Agent guide - anstyle-kotlin

This file is the quick-reference operating contract for anstyle-kotlin. The longer
...
anstyle-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`anstyle`](./README.md). Upstream Rust is the behavioral oracle while the
