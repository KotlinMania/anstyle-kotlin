...
kotlin {
    ...
    macosArm64 {
        binaries.framework { baseName = "Anstyle"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Anstyle"; xcf.add(this) }
    }
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleAnstyleXCFramework",
    "assembleAnstyleDebugXCFramework",
    "assembleAnstyleReleaseXCFramework",
    "assembleDebugIosFatFrameworkForAnstyleXCFramework",
    "assembleReleaseIosFatFrameworkForAnstyleXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForAnstyleXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForAnstyleXCFramework",
    "assembleDebugMacosFatFrameworkForAnstyleXCFramework",
    "assembleReleaseMacosFatFrameworkForAnstyleXCFramework",
    "assembleDebugTvosFatFrameworkForAnstyleXCFramework",
    "assembleReleaseTvosFatFrameworkForAnstyleXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForAnstyleXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForAnstyleXCFramework",
    "assembleDebugWatchosFatFrameworkForAnstyleXCFramework",
    "assembleReleaseWatchosFatFrameworkForAnstyleXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForAnstyleXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForAnstyleXCFramework",
